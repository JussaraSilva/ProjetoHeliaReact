...
import BookingForms from '../../src/components/modals/bookingForm';
...
export default function Details() {
  ...
  const houseReviews = reviewsData.reviews.filter(
  ...
  const [infos, setInfoBooking] = useState<{
    tenantName: string;
    tenantPhone: string;
    guests: number;
    notes: string;
  ...
  function handleInfoBookingSelected({
    tenantName,
    tenantPhone,
    guests,
    notes,
    ...
    // Navegar para a página de booking após a reserva ser feita
    router.push({
      pathname: '/stacks/confirmationReserv',
      params: {
        houseId: house?.id,
        houseName: house?.name,
        houseAddress: house?.address,
        houseImage: house?.gallery[0],
        housePrice: house?.price,
        houseAvaliation: house?.avaliation,
  ...
  return (
    <View style={styles.container}>
      <View style={styles.header}>
        <Image style={styles.headerImage} source={{ uri: house.gallery[0] }} />
      ...
      <ScrollView>
        <Text style={styles.imovelNameText}>{house.name}</Text>
        ...
        <View style={styles.containerGaleriaFotos}>
          <Text style={styles.containerGaleriaFotosTexto}>
            Galeria de Fotos
          </Text>
        ...
        <View style={styles.descriptionContainer}>
          ...
          <View style={styles.descriptionContent}>
            <Text style={styles.descriptionContainerText}>
              ...
              Molestiae, rem, laudantium modi omnis doloremque eos harum quidem
              distinctio dignissimos totam ducimus quos, accusamus eveniet nihil
              facilis quo consequuntur veritatis. Quisquam. Quia nam velit
              perspiciatis. Ducimus porro eius a, facere alias omnis inventore
              nobis maxime et quos maiores incidunt fuga, facilis esse fugit,
              asperiores voluptates eveniet sequi quasi! Quod, maxime dolor!
            </Text>
          </View>
        </View>
        ...
        <View style={styles.locationContainer}>
          ...
          <View style={styles.locationContainerMap}>
            <ExternalMap address={house.address} />
          </View>
        </View>
            ...
            <View style={styles.reviewsContentAvaliation}>
              ...
              <View style={styles.avaliationContainer}>
                <Icons.StarIcon
                  ...
                  weight='fill'
                />
                <Text style={styles.avaliationText}>{house.avaliation}</Text>
              </View>
            </View>
      ...
      <BookingForms
        ...
        onClose={() => setOpenCalendar(false)}
        onNext={handleInfoBookingSelected}
      />
    </View>
  );
}
