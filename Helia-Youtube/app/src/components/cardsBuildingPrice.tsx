...
export default function CardsBuildingPrice({ nameHouse, id, adress, image, price, iconAvaliation, avaliation, iconFavorite }: CardsBuildingPriceProps) {
                ...
                <View style={styles.card}>
                  <Pressable onPress={handleDetails}
                    ...
                    <View style={styles.cardInfoBuy}>
                      <Text style={styles.cardInfoBuyText}>{price}                        
                      </Text>
                      {iconFavorite}
                    </View>
                  </Pressable>
